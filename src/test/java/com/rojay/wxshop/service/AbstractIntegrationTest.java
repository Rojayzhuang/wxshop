...
import static com.rojay.wxshop.service.TelVerificationServiceTest.VALID_PARAMETER_CODE;
...
public class AbstractIntegrationTest {
    ...
    public UserLoginResponse loginAndGetCookie() throws JsonProcessingException {
        ...
        // 发送验证码
        int responseCode = doHttpRequest("/api/code", "POST", VALID_PARAMETER, null).code;
        Assertions.assertEquals(HTTP_OK, responseCode);

        // 带着验证码进行登录，得到Cookie
        HttpResponse loginResponse = doHttpRequest("/api/login", "POST", VALID_PARAMETER_CODE, null);
        ...
        statusResponse = doHttpRequest("/api/status", "GET", null, cookie).body;
